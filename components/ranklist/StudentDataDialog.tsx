...
export function StudentDataDialog(
    ...
    return (
        <Dialog
            ...
            onClose={()=> setStudentData(prevState =>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <p className="font-semibold">
                                Enrollment Number: <span className="font-normal">{studentData.data.enrollment}</span>
                            </p>
                            <p className="font-semibold">
                                Name: <span className="font-normal">{studentData.data.name}</span>
                            </p>
                            <p className="font-semibold">
                                Marks: <span className="font-normal">{studentData.data.marks} / {studentData.data.total}</span>
                            </p>
                            <p className="font-semibold">
                                Credit Marks: <span className="font-normal">{studentData.data.creditMarks} / {studentData.data.totalCreditMarks}</span>
                            </p>
                            {/*<p className="font-semibold">*/}
                        ...
                        <div>
                            <p className="font-semibold">
                                Percentage: <span className="font-normal">{studentData.data.percentage.toFixed(2)} %</span>
                            </p>
                            <p className="font-semibold">
                                Credit Percentage: <span className="font-normal">{studentData.data.creditsPercentage.toFixed(2)} %</span>
                            </p>
                            {/*<p className="font-semibold">*/}
