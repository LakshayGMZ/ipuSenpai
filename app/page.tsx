            ...
            <div className={"px-[15%]"}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-5">
                    <div className="text-center">
                        <h2 className="font-extrabold text-[rgba(255,255,255,0.6)] text-center break-words py-4 text-4xl font-bold mb-4">Frontend</h2>
                        <a href="https://github.com/LakshayGMZ/ipuSenpai/actions/workflows/production.yml">
                            <img src="https://github.com/LakshayGMZ/ipuSenpai/actions/workflows/production.yml/badge.svg" alt="Vercel Production Deployment" className="inline-block mx-2 my-2" />
                        </a>
                        <a href="https://github.com/LakshayGMZ/ipuSenpai/actions/workflows/preview.yml">
                            <img src="https://github.com/LakshayGMZ/ipuSenpai/actions/workflows/preview.yml/badge.svg?branch=devel" alt="Vercel Preview Deployment" className="inline-block mx-2 my-2" />
                        </a>
                        <a href="https://github.com/lakshayGMZ/ipuSenpai/issues">
                            <img src="https://img.shields.io/github/issues/lakshayGMZ/ipuSenpai" alt="GitHub issues" className="inline-block mx-2 my-2" />
                        </a>
                        <a href="https://github.com/lakshayGMZ/ipuSenpai/pulls">
                            <img src="https://img.shields.io/github/issues-pr/lakshayGMZ/ipuSenpai" alt="GitHub pull requests" className="inline-block mx-2 my-2" />
                        </a>
                        <a href="https://github.com/lakshayGMZ/ipuSenpai/graphs/contributors">
                            <img src="https://img.shields.io/github/contributors/lakshayGMZ/ipuSenpai" alt="GitHub contributors" className="inline-block mx-2 my-2" />
                        </a>
                        <a href="https://github.com/lakshayGMZ/ipuSenpai/blob/main/LICENSE">
                            <img src="https://img.shields.io/github/license/lakshayGMZ/ipuSenpai" alt="GitHub license" className="inline-block mx-2 my-2" />
                        </a>
                        <a href="https://github.com/lakshayGMZ/ipuSenpai/stargazers">
                            <img src="https://img.shields.io/github/stars/lakshayGMZ/ipuSenpai" alt="GitHub stars" className="inline-block mx-2 my-2" />
                        </a>
                        <a href="https://github.com/lakshayGMZ/ipuSenpai/network">
                            <img src="https://img.shields.io/github/forks/lakshayGMZ/ipuSenpai" alt="GitHub forks" className="inline-block mx-2 my-2" />
                        </a>
                        <a href="https://github.com/lakshayGMZ/ipuSenpai/watchers">
                            <img src="https://img.shields.io/github/watchers/lakshayGMZ/ipuSenpai" alt="GitHub watchers" className="inline-block mx-2 my-2" />
                        </a>
                    </div>
                    <div className="text-center">
                        <h2 className="font-extrabold text-[rgba(255,255,255,0.6)] text-center break-words py-4 text-4xl font-bold mb-4">Backend</h2>
                        <a href="https://github.com/martian0x80/IPUSenpaiBackend/actions/workflows/docker-workflow.yml">
                            <img src="https://github.com/martian0x80/IPUSenpaiBackend/actions/workflows/docker-workflow.yml/badge.svg" alt="IPUSenpai Backend" className="inline-block mx-2 my-2" />
                        </a>
                        <a href="https://www.rmrf.online/status/ipusenpai">
                            <img src="https://status.rmrf.online/api/badge/11/status?style=flat" alt="Uptime Status" className="inline-block mx-2 my-2" />
                        </a>
                        <a href="https://www.rmrf.online/status/ipusenpai">
                            <img src="https://status.rmrf.online/api/badge/11/ping?style=flat" alt="Uptime Ping" className="inline-block mx-2 my-2" />
                        </a>
                        <a href="https://www.rmrf.online/status/ipusenpai">
                            <img src="https://status.rmrf.online/api/badge/11/uptime?style=flat" alt="Uptime" className="inline-block mx-2 my-2" />
                        </a>
                        <a href="https://www.rmrf.online/status/ipusenpai">
                            <img src="https://status.rmrf.online/api/badge/11/response?style=flat" alt="Response Time" className="inline-block mx-2 my-2" />
                        </a>
                        <a href="https://github.com/martian0x80/IPUSenpaiBackend/issues">
                            <img src="https://img.shields.io/github/issues/martian0x80/IPUSenpaiBackend" alt="GitHub issues" className="inline-block mx-2 my-2" />
                        </a>
                        <a href="https://github.com/martian0x80/IPUSenpaiBackend/blob/master/LICENSE">
                            <img src="https://img.shields.io/github/license/martian0x80/IPUSenpaiBackend" alt="GitHub license" className="inline-block mx-2 my-2" />
                        </a>
                        <a href="https://github.com/martian0x80/IPUSenpaiBackend/commits/master">
                            <img src="https://img.shields.io/github/last-commit/martian0x80/IPUSenpaiBackend" alt="GitHub last commit" className="inline-block mx-2 my-2" />
                        </a>
                        <a href="https://github.com/martian0x80/IPUSenpaiBackend/pulls">
                            <img src="https://img.shields.io/github/issues-pr/martian0x80/IPUSenpaiBackend" alt="GitHub pull requests" className="inline-block mx-2 my-2" />
                        </a>
                        <a href="https://github.com/martian0x80/IPUSenpaiBackend/network">
                            <img src="https://img.shields.io/github/forks/martian0x80/IPUSenpaiBackend" alt="GitHub forks" className="inline-block mx-2 my-2" />
                        </a>
                        <a href="https://github.com/martian0x80/IPUSenpaiBackend/stargazers">
                            <img src="https://img.shields.io/github/stars/martian0x80/IPUSenpaiBackend" alt="GitHub stars" className="inline-block mx-2 my-2" />
                        </a>
                    </div>
                </div>
