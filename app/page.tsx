    ...
    <>
      <div className={"px-[15%]"}>
        ...
        <div className="bg-black bg-opacity-50 p-6 text-white text-center text-xl font-medium rounded-xl">
          <p>
            Contribute to this project on GitHub. We are open to contributions.
        ...
        <div className={"grid grid-cols-1"}>
          <div className="bg-black bg-opacity-50 p-6 text-white text-center text-xl font-medium rounded-xl">
            <p>
              Join our discord server to get latest updates and to discuss about
              the project.
            </p>
            <p className="py-2">OR</p>
            <p>
              Join our whatsapp group to get latest updates and to discuss about
              the project.
            </p>
